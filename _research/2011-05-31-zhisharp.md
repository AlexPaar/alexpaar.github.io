...
| 2012 | Symposium on Languages, Applications, and Technologies (SLATE) | *From Program Execution to Automatic Reasoning - Integrating Ontologies into Programming Languages* (Keynote) | [BibTeX](/bibliography/Paar12b.bib) [PDF](/bibliography/Paar12b.pdf)
| 2011 | Extended Semantic Web Conference (ESWC) | *Zhi# - OWL Aware Compilation* |
| 2010 | ICSE Workshop on Search-driven development: Users, Infrastructure, Tools and Evaluation | *Searching and Using External Types in an Extensible Software Development Environment* |
